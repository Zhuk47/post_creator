...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: '../wp-content/plugins/zh_post_editor/assets/nicEdit/nicEditorIcons.gif',
...
;
var nicEditors = {
    nicPlugins: [], editors: [], registerPlugin: function (B, A) {
        this.nicPlugins.push({p: B, o: A})
    }, allTextAreas: function (C) {
        var A = document.getElementsByClassName("zhTextarea");
        for (var B = 0; B < A.length; B++) {
...
var nicEditorInstance = bkClass.extend({
    isSelected: false, construct: function (G, D, C) {
        this.ne = C;
        this.elm = this.e = G;
        this.options = D || {};
    ...
    init: function () {
        ...
        for (itm in C) {
            ...
            if (A == "title") {
                ...
                if (D.txt) {
                    new bkElement("label").setAttributes({"for": itm}).setContent(D.txt).setStyle({
                        margin: "2px 4px",
                        fontSize: "13px",
                        width: "50px",
                        lineHeight: "20px",
        ...
        new bkElement("input").setAttributes({type: "submit"}).setStyle({
            backgroundColor: "#efefef",
            border: "1px solid #ccc",
            margin: "3px 0",
            "float": "left",
